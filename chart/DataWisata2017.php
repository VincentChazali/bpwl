...
<?php 
    ...
    $result = mysqli_query($conn,"select Monthname(bulan) as bulan,OWLinggoAsri,OWPantaiDepok from Data order by MONTH(bulan) desc");
    ...
    while($res = mysqli_fetch_array($result)){
        ...
        $OWLinggoAsri=$OWLinggoAsri."".$res['OWLinggoAsri'].",";
        $OWPantaiDepok=$OWPantaiDepok."".$res['OWPantaiDepok'].",";
    }
...
var options = {
    chart: {
        width: 1160,
        height: 650,
        title: 'Rekapitulasi Data Kunjungan Wisata di Kabupaten Pekalongan ',
        format: '1,000'
    },
    yAxis: {
        title: 'Bulan'
